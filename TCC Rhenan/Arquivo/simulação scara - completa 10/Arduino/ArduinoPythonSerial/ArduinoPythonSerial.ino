...
// Variaveis
// =================================================================================================
vector_angle setpoint, sensor, last_position;
vector4_angle inv;
vector_position dir;
...
void loop()
{
	vector_position home = create_point(0.0f, 0.0f);

	double start = millis();
	moveP(0.1f, 0.7f, false);
	double end = millis();

	debug("Tempo = ", (end - start));
	/*
	moveZ(0.03f, 0.001f);
	suction_on();
	moveZ(0.0f, 0.001f);

	moveP(0.6f, 0.1f, true);
