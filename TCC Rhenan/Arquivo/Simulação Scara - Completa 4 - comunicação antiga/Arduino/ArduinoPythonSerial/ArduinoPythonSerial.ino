...
void test_cycle()
{
	...
	float send_setpoint1 = round_1(setpoint1);
	float send_setpoint2 = round_1(setpoint2) + 90.0f;
	float send_setpoint3 = round_1(setpoint3);
	float send_setpoint4 = round_1(setpoint4) + 90.0f;
...
void com_cycle()
{
	//Trata dados a enviar
	float send_setpoint1 = round_1(setpoint1);
	float send_setpoint2 = round_1(setpoint2);
	...
	sensor1 = round_1(received_sensor1 / 10.0f);
	sensor2 = round_1(received_sensor2 / 10.0f);
}
