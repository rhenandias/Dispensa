...
void moveL(float x, float y, byte points)
{
	...
	if(dif_y <= threshold) 						interpolation_type = 0;	//Interpolação em x
	else if(dif_x <= threshold) 						interpolation_type = 1;	//Interpolação em y
	...
	switch(interpolation_type)
	{
		case 0:	step_x = dif_x / points;
				while(count++ < points)
				{
					...
					moveP(next_x, cur_position.y, true);
				}
			break;
		...
		case 1:	step_y = dif_y / points;
				while(count++ < points)
				{
					...
					moveP(cur_position.x, next_y, true);
				}
			break;
...
void loop()
{
	...
	//"I"
	cmd_up();
	moveP(-0.35f, 0.75f, true);	
	delay(500);
	cmd_down();
	moveL(-0.25f, 0.75f, 10);		
	cmd_up();
	moveP(-0.3f, 0.75f, true);	
	cmd_down();
	moveL(-0.3f, 0.55f, 10);		
	cmd_up();
	moveP(-0.35f, 0.55, true);	
	cmd_down();
	moveL(-0.25f, 0.55f, 10);
	cmd_up();
	...
	delay(500);
	cmd_down();
	moveL(-0.15f, 0.75f, 10);
	moveL(-0.05f, 0.75f, 10);
	cmd_up();
	moveP(-0.15f, 0.65f, true);
	cmd_down();
	moveL(-0.05f, 0.65f, 10);
	cmd_up();

	//"S"
	moveP(0.15f, 0.75f, true);
	delay(500);
	cmd_down();
	moveL(0.05f, 0.75f, 10);
	moveL(0.05f, 0.65f, 10);
	moveL(0.15f, 0.65f, 10);
	moveL(0.15f, 0.55f, 10);
	moveL(0.05f, 0.55f, 10);
	cmd_up();

	//"P"
	moveP(0.25f, 0.55f, true);
	delay(500);
	cmd_down();
	moveL(0.25f, 0.75f, 10);
	moveL(0.35f, 0.75f, 10);
	moveL(0.35f, 0.65f, 10);
	moveL(0.25f, 0.65f, 10);
	cmd_up();
	...
	//Letra "I" grande
	cmd_up();
	moveP(-0.8f, 0.1f, true);	//Move para ponto A
	delay(500);
	cmd_down();
	moveL(-0.6f, 0.1f, 10);		//Move de A a B
	cmd_up();
	moveP(-0.7f, 0.1f, true);	//Move para ponto C
	cmd_down();
	moveL(-0.7f, -0.2f, 10);		//Move de C a D
	cmd_up();
	moveP(-0.8f, -0.2f, true);	//Move para ponto F
	cmd_down();
	moveL(-0.6f, -0.2f, 10);
	cmd_up();
	moveJ(90.0f, 0.0f, true);
